    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if len(phone_number) == 10:
                ...
                messages.success(
                    request, 'OTP has been sent to ' + str(phone_num))
...
def address(request):
    ...
    try:
        if request.method == 'POST':
            ...
            address = Address(user_id=us, first_name=first_name, last_name=last_name, email=email, phone_number=phone_number,
                              address_line_1=address_line_1, address_line_2=address_line_2, city=city, state=state, country=country)
